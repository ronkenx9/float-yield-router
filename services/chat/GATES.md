...
- [x] G1: Behavioral tests pass (signature verify, skew, parser, allowlist refusal, dedupe, skills incl. screener intent/params/replies, approve→receipt, reject, brain fallback, chunking).
  ...
  EVIDENCE: manual; 18 pass / 0 fail, 17 September 2026.
