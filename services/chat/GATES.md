...
- [x] G1: Behavioral tests pass (signature verify, skew, parser, allowlist refusal, dedupe, skills incl. screener and swap intent/parse/quote/gate/approve, approve→receipt, reject, brain fallback, chunking).
  ...
  EVIDENCE: manual; 28 pass / 0 fail, 17 September 2026.
